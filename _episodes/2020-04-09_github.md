...
**You do not need to do this again if you attended out first workshop on command line git.**

When we use Git on a new computer for the first time,
we need to configure a few things. Below are the commands needed for basic setup including:

*   name and email address,
*   preferred text editor,
*   and that we want to use these settings globally (i.e. for every project).

For more details, see the previous workshop.
